...
optional_ptr<CatalogEntry> GraphArSchemaEntry::CreateFunction(CatalogTransaction transaction,
...
void GraphArUnqualifyColumnRef(ParsedExpression& expr) {
    if (expr.GetExpressionType() == ExpressionType::COLUMN_REF) {
        ...
        auto name = std::move(colref.ColumnNames().back());
...
optional_ptr<CatalogEntry> GraphArSchemaEntry::CreateSequence(CatalogTransaction transaction,
...
optional_ptr<CatalogEntry> GraphArSchemaEntry::CreateCollation(CatalogTransaction transaction,
